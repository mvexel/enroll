...
python /home/mvexel/pygal/PyGallery.py --Gui=0 --Style=Gallery --InputDir=/home/mvexel/www/ARTH/ --Title=EnrollmentARTH --WritePictureName=1 --PicsPerGallery=100 --OutputDir=/home/mvexel/www/enrollment/ARTH > /dev/null 2>&1
...
END=$(date +%s)
DIFF=$(( $END - $START ))
echo "`date`: new galleries created. done. took $DIFF secs" >> /home/mvexel/enroll/enroll.log
